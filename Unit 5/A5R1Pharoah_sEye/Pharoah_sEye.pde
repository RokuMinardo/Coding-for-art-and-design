...
//Wanted to add a winscreen but had to leave that out as I haven't figured that out.
  ...
  p1Servants.add(new Card("Pharaoh", 1000, 3000, 1, true, color(#908729)));
  p1Servants.add(new Card("Asfet:The Fallen", 2000, 1700, 1, false, color(#caca5d)));
  p1Servants.add(new Card("Mummy Gal", 1500, 3, 3, false, color(#caca5d)));
  p1Servants.add(new Card("Currupted One", 200, 5000, 1, false, color(#caca5d)));
  p1Servants.add(new Card("Successor of Ra", 1500, 3000, 1, false, color(#caca5d)));
  p1Servants.add(new Card("Bladed One", 300, 500, 2, false, color(#caca5d)));
  p1Servants.add(new Card("Phant:Prideful", 500, 4000, 1, false, color(#caca5d)));
  p1Servants.add(new Card("Stone:Willed", 500, 3500, 5, false, color(#caca5d)));

  p2Servants.add(new Card("Pharaoh", 1000, 3000, 1, true, color(#2f5089)));
  p2Servants.add(new Card("Asfet:The Fallen", 2000, 1700, 1, false, color(#7a93be)));
  p2Servants.add(new Card("Mummy Gal", 1500, 3, 3, false, color(#7a93be)));
  p2Servants.add(new Card("Currupted One", 200, 5000, 1, false, color(#7a93be)));
  p2Servants.add(new Card("Successor of Ra", 1500, 3000, 1, false, color(#7a93be)));
  p2Servants.add(new Card("Bladed One", 300, 500, 2, false, color(#7a93be)));
  p2Servants.add(new Card("Phant:Prideful", 500, 4000, 1, false, color(#7a93be)));
  p2Servants.add(new Card("Stone:Willed", 500, 3500, 5, false, color(#7a93be)));
